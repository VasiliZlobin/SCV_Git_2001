...
2. Синхронизировать свою версию репозитория с локальным.
...
4. Отправить версию локального репозитория в свой удаленный репозиторий (`git pull`). На странице удаленного репозитория создать pull request и отправить его.